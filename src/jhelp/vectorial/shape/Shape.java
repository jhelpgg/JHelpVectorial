      ...
      implements VectorialConstants, PathChangeListener
{
    ...
    *            If JSON not represents a valid shape
    */
    ...
    * 
    * @param shapeDrawer
    *           Shape drawer, that will receive lines to draw
    */
    ...
    * 
    * @param shapeFiller
    *           Shape fill that will fill the shape
    */
    ...
    * @param path
    *           Changed path
    * @see jhelp.vectorial.event.PathChangeListener#pathChanged(jhelp.vectorial.path.Path)
    */
   @Override
   ...
   public void registerShapeChangeListener(final ShapeChangeListener shapeChangeListener)
   {
      ...
      {
         throw new NullPointerException("shapeChangeListener musn't be null");
      }
   ...
   {
      if((UtilMath.sign(scaleX) <= 0) || (UtilMath.sign(scaleY) <= 0))
      {
   ...
   public List<Line> toPolyline()
   {
      ...
      final LineCollector lineCollector = new LineCollector(list, this.x, this.y, this.scaleX, this.scaleY, this.precision);
