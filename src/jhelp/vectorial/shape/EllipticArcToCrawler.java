 ...
 * More precision give a better look, but give also more line/point to draw, so you have to find the good compromise
 * depends on
...
public class EllipticArcToCrawler
{
     ...
     *           Angle for rotate ellipse in degree
     * @param largeArc
     *           Indicates if choose the large arc or not
     * @param sweep
     *           Indicates if choose the sweep or not
     * @param endX
     *           End point X
     * @param endY
     *           End point Y
     ...
     *           Precision to use
     */
    public EllipticArcToCrawler(final double startX, final double startY, double radiusX, double radiusY,
                                final double rotationAxisXInDegree,
                                final boolean largeArc, final boolean sweep, final double endX, final double endY,
                                final int precision)
    {
        this.startX = startX;
        this.startY = startY;
