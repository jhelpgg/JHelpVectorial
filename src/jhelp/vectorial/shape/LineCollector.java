        ...
        implements PathDrawer
{
     ...
     *           Precision to use
     */
    public LineCollector(final List<Line> list, final double x, final double y, final double scaleX, final double scaleY,
                         final int precision)
    {
        if (list == null)
        {
     ...
     */
    @Override
    public void cubicBezierTo(final double firstControlPointX, final double firstControlPointY,
                              final double secondControlPointX,
                              final double secondControlPointY, final double x, final double y)
    {
        this.bufferX = UtilMath.PCubiques(this.lastX, firstControlPointX, secondControlPointX, x, this.precision,
                                          this.bufferX);
        this.bufferY = UtilMath.PCubiques(this.lastY, firstControlPointY, secondControlPointY, y, this.precision,
                                          this.bufferY);
     ...
     */
    @Override
    public void ellipticalArcTo(final double radiusX, final double radiusY, final double rotationAxisXInDegree,
                                final boolean largeArc, final boolean sweep,
                                final double x, final double y)
    {
        ...
        if ((UtilMath.equals(this.lastX, x)) && (UtilMath.equals(this.lastY, y)))
        {
            return;
        }
