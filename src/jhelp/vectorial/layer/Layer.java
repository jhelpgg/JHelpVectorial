      ...
      implements ShapeDescriptionChangeListener
{
    ...
    *           Line thickness
    */
   private void draw(final int width, final int height, final int[] pixels, final Shape shape, final int color, final int strokeWidth)
   {
      final ThickLineShapeDrawer thickLineShapeDrawer = new ThickLineShapeDrawer(width, height, pixels, color, strokeWidth);
    ...
    *           Factor of variation
    */
   private void drawNeon(final int width, final int height, final int[] pixels, final Shape shape, final int color, final int strokeWidth,
         final double neonFactor)
   {
      final NeonShapeDrawer neonShapeDrawer = new NeonShapeDrawer(width, height, pixels, color, strokeWidth, neonFactor);
    ...
    *           Texture to use
    */
   private void fill(final int width, final int height, final int[] pixels, final Shape shape, final JHelpImage texture)
   {
   ...
   public void addShape(final ShapeDescription shapeDescription)
   {
      ...
      {
         throw new NullPointerException("shapeDescription musn't be null");
      }
    ...
    *           Variation factor
    */
   public void fillAndStrokeNeon(final Shape shape, final int fillColor, final int strokeColor, final int strokeWidth, final double neonFactor)
   {
      this.addShape(ShapeDescription.createFillAndStrokeNeonDescription(shape, fillColor, strokeColor, strokeWidth, neonFactor));
   }
    ...
    *           Variation factor
    */
   public void fillAndStrokeNeon(final Shape shape, final JHelpImage texture, final int strokeColor, final int strokeWidth, final double neonFactor)
   {
      this.addShape(ShapeDescription.createFillAndStrokeNeonDescription(shape, texture, strokeColor, strokeWidth, neonFactor));
   }
    ...
    *           Variation factor
    */
   public void fillAndStrokeNeon(final Shape shape, final JHelpPaint paint, final int strokeColor, final int strokeWidth, final double neonFactor)
   {
      this.addShape(ShapeDescription.createFillAndStrokeNeonDescription(shape, paint, strokeColor, strokeWidth, neonFactor));
   }
