      ...
      implements ShapeChangeListener
{
    ...
    */
   public static ShapeDescription createFillAndStrokeDescription(final Shape shape, final int fillColor, final int strokeColor)
   {
      if(shape == null)
      {
    ...
    * @return Description created
    */
   public static ShapeDescription createFillAndStrokeDescription(final Shape shape, final int fillColor, final int strokeColor, final int strokeWidth)
   {
      if(shape == null)
      {
         throw new NullPointerException("shape musn't be null");
      ...
      return new ShapeDescription(shape, Style.FILL_AND_STROKE, fillColor, null, null, strokeColor, Math.max(1, strokeWidth), false, 1.5);
   }
    ...
    * @return Description created
    */
   public static ShapeDescription createFillAndStrokeDescription(final Shape shape, final JHelpImage texture, final int strokeColor)
   {
      if(shape == null)
      {
         throw new NullPointerException("shape musn't be null");
    ...
    * @return Description created
    */
   public static ShapeDescription createFillAndStrokeDescription(final Shape shape, final JHelpImage texture, final int strokeColor, final int strokeWidth)
   {
      if(shape == null)
      {
         throw new NullPointerException("shape musn't be null");
      ...
      return new ShapeDescription(shape, Style.FILL_AND_STROKE, 0, texture, null, strokeColor, Math.max(1, strokeWidth), false, 1.5);
   }
    ...
    * @return Description created
    */
   public static ShapeDescription createFillAndStrokeDescription(final Shape shape, final JHelpPaint paint, final int strokeColor)
   {
      if(shape == null)
      {
         throw new NullPointerException("shape musn't be null");
    ...
    * @return Description created
    */
   public static ShapeDescription createFillAndStrokeDescription(final Shape shape, final JHelpPaint paint, final int strokeColor, final int strokeWidth)
   {
      if(shape == null)
      {
         throw new NullPointerException("shape musn't be null");
      ...
      return new ShapeDescription(shape, Style.FILL_AND_STROKE, 0, null, paint, strokeColor, Math.max(1, strokeWidth), false, 1.5);
   }
    ...
    * @return Description created
    */
   public static ShapeDescription createFillAndStrokeNeonDescription(final Shape shape, final int fillColor, final int strokeColor, final int strokeWidth,
         final double neonFactor)
   {
      ...
      if(UtilMath.sign(neonFactor) <= 0)
      {
         throw new IllegalArgumentException("Neon factor MUST be >0, not :" + neonFactor);
      }

      return new ShapeDescription(shape, Style.FILL_AND_STROKE, fillColor, null, null, strokeColor, Math.max(1, strokeWidth), true, neonFactor);
   }
    ...
    * @return Description created
    */
   public static ShapeDescription createFillAndStrokeNeonDescription(final Shape shape, final JHelpImage texture, final int strokeColor, final int strokeWidth,
         final double neonFactor)
   {
      if(shape == null)
      {
      ...
      return new ShapeDescription(shape, Style.FILL_AND_STROKE, 0, texture, null, strokeColor, Math.max(1, strokeWidth), true, neonFactor);
   }
    ...
    * @return Description created
    */
   public static ShapeDescription createFillAndStrokeNeonDescription(final Shape shape, final JHelpPaint paint, final int strokeColor, final int strokeWidth,
         final double neonFactor)
   {
      if(shape == null)
      {
      ...
      return new ShapeDescription(shape, Style.FILL_AND_STROKE, 0, null, paint, strokeColor, Math.max(1, strokeWidth), true, neonFactor);
   }
    ...
    *           Border thickness
    * @param neonFactor
    *           Variation color factor
    * @return Description created
    */
   public static ShapeDescription createStrokeNeonDescription(final Shape shape, final int color, final int strokeWidth, final double neonFactor)
   {
      if(shape == null)
      {
         throw new NullPointerException("shape musn't be null");
      ...
      return new ShapeDescription(shape, Style.STROKE, 0, null, null, color, Math.max(1, strokeWidth), true, neonFactor);
   }
    ...
    *           Color variation factor
    */
   private ShapeDescription(final Shape shape, final Style style, final int fillColor, final JHelpImage fillTexture, final JHelpPaint fillPaint,
    ...
    * 
    * @param shapeDescriptionChangeListener
    *           Listener to register
    */
   public void registerShapeDescriptionChangeListener(final ShapeDescriptionChangeListener shapeDescriptionChangeListener)
   {
      if(shapeDescriptionChangeListener == null)
      {
         throw new NullPointerException("shapeDescriptionChangeListener musn't be null");
      }
    ...
    * 
    * @param stokeIsNeon
    *           New usage of color variation status
    */
    ...
    * @param shape
    *           Changed shape
    * @see jhelp.vectorial.event.ShapeChangeListener#shapeChanged(jhelp.vectorial.shape.Shape)
    */
   @Override
    ...
    */
   public void unregisterShapeDescriptionChangeListener(final ShapeDescriptionChangeListener shapeDescriptionChangeListener)
   {
      synchronized(this.listeners)
      {
