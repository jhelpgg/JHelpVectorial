...
public interface PathDrawer
{
     ...
     */
    public void cubicBezierTo(double firstControlPointX, double firstControlPointY, double secondControlPointX,
                              double secondControlPointY, double x, double y);
     ...
     * @param y                     Final point Y
     */
    public void ellipticalArcTo(double radiusX, double radiusY, double rotationAxisXInDegree, boolean largeArc,
                                boolean sweep, double x, double y);
