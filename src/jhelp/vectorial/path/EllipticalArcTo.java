      ...
      extends PathElement
{
    ...
    *           Final point Y
    */
   public EllipticalArcTo(final boolean relative, final double radiusX, final double radiusY, final double rotationAxisXInDegree, final boolean largeArc,
   ...
   protected boolean equalsIntern(final PathElement pathElement)
   {
      ...
      return (UtilMath.equals(this.radiusX, ellipticalArcTo.radiusX) == true)//
            && (UtilMath.equals(this.radiusY, ellipticalArcTo.radiusY) == true)//
            && (UtilMath.equals(this.rotationAxisXInDegree, ellipticalArcTo.rotationAxisXInDegree) == true)//
            && (this.largeArc == ellipticalArcTo.largeArc)//
            && (this.sweep == ellipticalArcTo.sweep)//
            && (UtilMath.equals(this.x, ellipticalArcTo.x) == true)//
            && (UtilMath.equals(this.y, ellipticalArcTo.y) == true)//
      ;
   }
   ...
   public Point draw(final PathDrawer pathDrawer, final double referenceX, final double referenceY)
   {
      ...
      pathDrawer.ellipticalArcTo(this.radiusX, this.radiusY, this.rotationAxisXInDegree, this.largeArc, this.sweep, x, y);
   ...
   {
      if(UtilMath.equals(this.radiusX, radiusX) == true)
      {
         return;
      }
   ...
   {
      if(UtilMath.equals(this.radiusY, radiusY) == true)
      {
         return;
      }
    ...
    * 
    * @param rotationAxisXInDegree
    *           New rotation around X Axis
    */
   public void setRotationAxisXInDegree(final double rotationAxisXInDegree)
   {
      if(UtilMath.equals(this.rotationAxisXInDegree, rotationAxisXInDegree) == true)
      {
         return;
      }
