        ...
        implements VectorialConstants, PathElementChangeListener
{
            ...
            throws ParsePathException
    {
        ...
        try
        {
            final ArrayJSON arrayJSON = json.get(VectorialConstants.KEY_PATH)
                                            .getArray();
            final int       length    = arrayJSON.numberOfValue();

            for (int element = 0; element < length; element++)
            {
                this.addElement(PathElement.parse(arrayJSON.getValue(element)
                                                           .getObject()));
            }
        }
     ...
     * @return Created path
     */
    public static Path createArc(final double x, final double y, final double width, final double height,
                                 final double angleStart, final double angleTotal,
     ...
     * @return Created path
     */
    public static Path createCenterArc(final double centerX, final double centerY, final double radiusX,
                                       final double radiusY, double angleStart,
     ...
     * @return Created path
     */
    public static Path createCenterEllipse(final double centerX, final double centerY, final double radiusX,
     ...
     * @return Created path
     */
    public static Path createCenterRectangle(final double centerX, final double centerY, final double width,
                                             final double height)
    {
     ...
     * @return Created path
     */
    public static Path createRoundRectangle(final double x, final double y, final double width, final double height,
    ...
    public void parse(final String string)
    {
        ...
        final char[]          characters   = string.trim()
                                                   .toCharArray();
        double                firstX       = 0;
        double                firstY       = 0;
        double                referenceX   = 0;
        ...
        while (index < length)
        {
            ...
            do
            {
                ...
                switch (character)
                {
                    ...
                    case 'C':
                    case 'c':
                        this.addElement(new CubicBezierTo(relative, values[0], values[1], values[2], values[3], values[4],
                                                          values[5]));
                        referenceX = values[4];
                        referenceY = values[5];
                    ...
                    case 'S':
                    case 's':
                        this.addElement(new CubicBezierTo(relative, referenceX + cubicSecondX, referenceY + cubicSecondY,
                    ...
                    case 'a':
                        this.addElement(new EllipticalArcTo(relative, values[0], values[1], values[2],
                                                            UtilMath.equals(values[3], 1), UtilMath.equals(values[4], 1),
                                                            values[5], values[6]));
                        referenceX = values[5];
                        referenceY = values[6];
                        cubicSecondX = 0;
            ...
            while ((index < length) && (Path.isNumberCharacter(characters[index])));
        }
     ...
     *
     * @param relative
     *           Indicates if coordinates are relative to current point ({@code true}) OR coordinates are absolute
     *           ({@code false}
     *           )
     ...
     *           Final point Y
     */
    public void cubicBezierTo(final boolean relative, final double firstControlPointX, final double firstControlPointY,
     ...
     *           Final point Y
     */
    public void ellipticalArcTo(final boolean relative, final double radiusX, final double radiusY,
                                final double rotationAxisXInDegree, final boolean largeArc,
     ...
     *           Final point Y
     */
    public void quadricBezierTo(final boolean relative, final double controlPointX, final double controlPointY,
    ...
    public void registerPathChangeListener(final PathChangeListener pathChangeListener)
    {
        ...
        synchronized (this.listeners)
        {
            if (!this.listeners.contains(pathChangeListener))
            {
