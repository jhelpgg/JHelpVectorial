...
public class Matrix
{
    ...
    *           Matrix position 2,1
    */
   public Matrix(final double matrix00, final double matrix10, final double matrix20, final double matrix01, final double matrix11, final double matrix21)
   {
   ...
   public int hashCode()
   {
      return HashCode.computeHashCode(this.determinant, this.matrix00, this.matrix10, this.matrix20, this.matrix01, this.matrix11, this.matrix21,
    ...
    * 
    * @param result
    *           Matrix where write the result, if {@code null} a new matrix is created
   ...
   public Matrix multiply(final Matrix matrix, Matrix result)
   {
      ...
      final double m00 = (this.matrix00 * matrix.matrix00) + (this.matrix10 * matrix.matrix01) + (this.matrix20 * matrix.matrix02);
      final double m10 = (this.matrix00 * matrix.matrix10) + (this.matrix10 * matrix.matrix11) + (this.matrix20 * matrix.matrix12);
      final double m20 = (this.matrix00 * matrix.matrix20) + (this.matrix10 * matrix.matrix21) + (this.matrix20 * matrix.matrix22);
      final double m01 = (this.matrix01 * matrix.matrix00) + (this.matrix11 * matrix.matrix01) + (this.matrix21 * matrix.matrix02);
      final double m11 = (this.matrix01 * matrix.matrix10) + (this.matrix11 * matrix.matrix11) + (this.matrix21 * matrix.matrix12);
      final double m21 = (this.matrix01 * matrix.matrix20) + (this.matrix11 * matrix.matrix21) + (this.matrix21 * matrix.matrix22);
      final double m02 = (this.matrix02 * matrix.matrix00) + (this.matrix12 * matrix.matrix01) + (this.matrix22 * matrix.matrix02);
      final double m12 = (this.matrix02 * matrix.matrix10) + (this.matrix12 * matrix.matrix11) + (this.matrix22 * matrix.matrix12);
      final double m22 = (this.matrix02 * matrix.matrix20) + (this.matrix12 * matrix.matrix21) + (this.matrix22 * matrix.matrix22);
    ...
    *           Point to transform
    * @param result
    *           Point where write result, if {@code null} a new instance is created
